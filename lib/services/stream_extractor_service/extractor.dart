...
import "package:index/services/stream_extractor_service/extractors/kiss_kh_extractor.dart";
import "package:index/services/stream_extractor_service/extractors/superembed_extractor.dart";
import "package:index/services/stream_extractor_service/extractors/vidsrc_extractor.dart";
import "package:index/services/stream_extractor_service/extractors/embedsu_extractor.dart";
...
class StreamExtractor {
  ...
  static final List<StreamingServer> _streamingServers = <StreamingServer>[
    ...
    StreamingServer(name: "VidSrc", extractor: VidSrcExtractor()),
    StreamingServer(name: "EmbedSu", extractor: EmbedSuExtractor()),
  ...
  static Future<MediaStream?> getStream({Movie? movie, TvShow? tvShow, Episode? episode}) async {
    try {
      ...
      if (movie != null) {
        ...
        streamExtractorOptions = StreamExtractorOptions(
          tmdbId: tvShow.id, // Use TV show ID, not episode ID
