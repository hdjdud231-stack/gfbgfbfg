...
class UpdateMovieProgress extends AppEvent {
  const UpdateMovieProgress(this.movieId, this.movie, this.progress, this.duration);
...
class UpdateEpisodeProgress extends AppEvent {
  const UpdateEpisodeProgress(this.tvShowId, this.tvShow, this.seasonId, this.episodeId, this.progress, this.duration);
