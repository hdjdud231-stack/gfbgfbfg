...
import "package:index/services/stream_extractor_service/extractor.dart";
...
class _SettingsScreenState extends BaseScreenState<SettingsScreen> {
                      ...
                      children: <TextSpan>[
                        ...
                        TextSpan(
                          ...
                          recognizer: TapGestureRecognizer()..onTap = () async {
                            await launchUrl(Uri.parse("https://voxin.dev"));
                          },
                        ),
                      ],
                    ),
  ...
  Future<void> _reAuthenticate() async {
    ...
    try {
      // Guest mode - no re-authentication needed
    } catch (_) {
      if (mounted) {
        showSnackBar(context, "فشل في إعادة المصادقة");
      }
    }
  ...
  Future<void> _signOut() async {
    try {
      ...
      if (mounted) {
        showSnackBar(context, "فشل في تسجيل الخروج");
      }
    }
  }
